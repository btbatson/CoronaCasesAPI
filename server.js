...
var getcountries = setInterval(async () => {
  ...
  const casesColIndex = 1;	  const casesColIndex = 2;
  const todayCasesColIndex = 2;	  const todayCasesColIndex = 3;
  const deathsColIndex = 3;	  const deathsColIndex = 4;
  const todayDeathsColIndex = 4;	  const todayDeathsColIndex = 5;
  const curedColIndex = 5;	  const curedColIndex = 6;
  const activeColIndex = 6;	  const activeColIndex = 7;
  const criticalColIndex = 7;	  const criticalColIndex = 8;
  const casesPerOneMillionColIndex = 8;	  const casesPerOneMillionColIndex = 9;
  const deathsPerOneMillionColIndex = 9;	  const deathsPerOneMillionColIndex = 10;
  const totalTestsColIndex = 10;	  const totalTestsColIndex = 11;
  const testsPerOneMillionColIndex = 11;	  const testsPerOneMillionColIndex = 12;
